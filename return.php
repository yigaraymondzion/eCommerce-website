...
?>
        ...
        <fieldset> <textarea placeholder="Type your message here..." name="desc" tabindex="5" required></textarea> </fieldset>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $return_product = "INSERT into order_return set 
        ...
        if($run_return_product=true)
        {
            echo "<script>alert('We will let you when the product')</script>";
        }
